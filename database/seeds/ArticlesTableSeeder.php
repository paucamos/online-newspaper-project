...
class ArticlesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('articles')->insert([
            ...
            'description' => "Espanyol. Amb l’eliminatòria solucionada, el conjunt blanc-i-blau vol tornar a agafar moral amb una victòria en un partit oficial amb vistes a la propera eliminatòria de classificació",
